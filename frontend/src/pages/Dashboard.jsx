...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#040612] to-[#135e3f] flex flex-col justify-center items-center">
  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
      <div className="relative w-full h-[306px] bg-gradient-to-r from-[#040612] to-[#135e3f] overflow-hidden">
        <img
          src="/login_img.png"
